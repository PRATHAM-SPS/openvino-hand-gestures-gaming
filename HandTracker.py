...
left_hand = None 
right_hand =None
# from directkeys import keyboard.press, keyboard.release
import keyboard
...
class HandTracker:
    ...
    def recognize_gesture_left(self, l): 
        r = l
        global  left_hand
        # Finger states
        f = r.handedness
        ...
        if r.thumb_state == 1 and r.index_state == 1 and r.middle_state == 1 and r.ring_state == 1 and r.little_state == 1 and r.handedness < 0.5:
            left_hand = "Left FIVE"
        elif r.thumb_state == 0 and r.index_state == 0 and r.middle_state == 0 and r.ring_state == 0 and r.little_state == 0 and r.handedness < 0.5:
            left_hand = "Left FIST"
        else:
           r.gesture = None
        return left_hand
    ...
    def recognize_gesture_right(self, r):
        # Finger states
        f = r.handedness
        r.gesture = None
        global right_hand
        ...
        if r.thumb_state == 1 and r.index_state == 1 and r.middle_state == 1 and r.ring_state == 1 and r.little_state == 1 and r.handedness > 0.5:
            right_hand ="Right FIVE"
        elif r.thumb_state == 0 and r.index_state == 0 and r.middle_state == 0 and r.ring_state == 0 and r.little_state == 0 and r.handedness > 0.5:
            right_hand ="Right FIST"
        else:
            r.gesture = None
            # right_hand =None
        return right_hand
    ...
    def control(self):
        global left_hand
        global right_hand
        if left_hand == "Left FIVE" and right_hand == "Right FIVE":
            keyboard.release('left')
            keyboard.release('right')
            keyboard.release('down')
            keyboard.press('up')
            print("MOVE FORWARD")
        elif left_hand == "Left FIVE" and right_hand == "Right FIST":
            keyboard.release('up')
            keyboard.release('left')
            keyboard.release('down')
            keyboard.press('right')
            print("TURN RIGHT")
        elif left_hand == "Left FIST" and right_hand == "Right FIVE":
            keyboard.release('right')
            keyboard.release('down')
            keyboard.release('up')
            keyboard.press('left')
            print("TURN LEFT")
        elif left_hand == "Left FIST" and right_hand == "Right FIST":
            keyboard.release('up')
            keyboard.release('left')
            keyboard.release('right')
            keyboard.press('down')
            print("MOVE BACKWARDS OR APPLY BRAKES")
        else:
            left_hand = None
            right_hand = None
    ...
    def lm_postprocess(self, region, inference):
        ...
        region.landmarks = lm
        if self.use_gesture: self.recognize_gesture_left(region) , self.recognize_gesture_right(region) 
